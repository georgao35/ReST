...
from env.mujoco.mujoco_utils import MujocoTrait
...
class HalfCheetahEnv(MujocoTrait, mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def calc_eval_metrics(self, trajectories, is_option_trajectories, num_coord_dims=1):
